import sys, pcbnew, traceback, warnings
...
if kicad7:
    ...
    PrimPointType: TypeAlias = pcbnew.VECTOR2I
else:
    iu2mm = pcbnew.Iu2Millimeter
    PrimPointType: TypeAlias = pcbnew.wxPoint
...
class Board:
    def __init__(self, name: str) -> None:
        ...
        self.center: PrimPointType = self.board.GetDesignSettings().GetAuxOrigin()

    def p(self, l: PrimPointType) -> Tuple[float, float]:
        rel = l - self.center
            ...
            for shape in shapes:
                match shape.GetShape():
                    ...
                    case pcbnew.SHAPE_T_POLY:
                        ...
                        points = [self.p(_poly_shape_point(shape.CVertex(i))) for i in range(shape.VertexCount())]
